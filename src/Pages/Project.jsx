...
const projects = [
  {
    ...
    type: "fullstack",
    image: "https://i.ibb.co.com/ndNc7sW/puratonbazar-netlify-app.png",
    description:
  ...
  },
  {
    ...
    type: "frontend",
    image: "https://i.ibb.co.com/rK5tyxGm/localhost-5173.png",
    description:
  ...
  return (
    <section className="bg-backgroundDark py-20 min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <h1
          data-aos="fade-down"
          className="text-4xl font-bold text-buttonBankground mb-6 text-center dark:text-textColor"
        >
          My Projects
        </h1>
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`${activeTab === tab
                ...
                } border-t-2 border-r-2 border-l-2 p-2 rounded-md transition-all duration-300 hover:shadow-md hover:shadow-buttonBankground dark:text-textColor`}
            >
              {tab}
            </button>
          ))}
