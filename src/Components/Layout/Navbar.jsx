...
const Navbar = () => {
  ...
  return (
    <div className="navbar border-b-2 bg-base-100 bg-opacity-90 shadow-sm fixed top-0 left-0 w-full z-50 text-xl font-bold px-10 transition-colors duration-300">
      ...
      <div className="navbar-end flex items-center gap-2">
        ...
        <label className="swap swap-rotate">
          {/* 🔘 Hidden Checkbox (Controls the swap) */}
          <input
            type="checkbox"
            ref={checkboxRef}
