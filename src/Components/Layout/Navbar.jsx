...
const Navbar = () => {
  ...
  return (
    <div className="transition-colors duration-300  text-textColor dark:text-textColor border-b-2 border-b-borderColor bg-backgroundBg dark:bg-backgroundDark bg-opacity-90 z-50 shadow-sm fixed top-0 left-0 w-full z-50n">
